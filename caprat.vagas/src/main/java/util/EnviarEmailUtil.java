...
public class EnviarEmailUtil {
	...
	public void enviarEmailCadastro(UsuarioLogin dadosLogin) {
		String htmlEmail = 
				...
				"                        <p style=\"margin:0; font-family: Arial, Calibri, Verdana, Helvetica, sans-serif; font-size: 20px; color: #ffffff; line-height: 150%; line=height:24px; mso-line-height-rule:exactly;\" class=\"\">Olá <span style=\"color: #BAD1CE;\">" + dadosLogin.getApelidoUsuario() + ",</span> <br><br>Bem-vindo ao CAPRAT Vagas! Você está prestes embarcar no início do seu futuro, aperte os cintos e bora caçar um trampo!<br><br>\r\n" + 
				"                          Seguem seus dados:\r\n" + 
				"                          <br>E-mail: <span style=\"color: #BAD1CE;\">" + dadosLogin.getEmailUsuario() + "</span><br>Senha: <span style=\"color: #BAD1CE;\"> " + dadosLogin.getSenhaUsuario() + " </span><br><br>\r\n" + 
		...
		this.enviarEmail(dadosLogin.getEmailUsuario(), "Seja bem vindo à equipe CAPRAT!", htmlEmail);
	}
